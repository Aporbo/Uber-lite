    ...
    return (
        <div>
            ...
            <form className="container mt-5">
                ...
                <div class="mb-3">
                    {newUser && <input type="number" name="phone-number" placeholder="Phone" onBlur={handleBlur} class="form-control" id="phone" aria-describedby="emailHelp" required/>}
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3 form-check">
                    ...
                    <label htmlFor="newUser" class="form-check-label" for="exampleCheck1"><b>don't have account? click to checkbox</b></label>
                </div>
                <button onClick={handleSubmit} type="submit" value="submit" class="btn btn-primary">Create Account</button>
            </form>
            ...
            <div className="container">
                ...
                <button onClick={handleGoogleSignIn} className="btn-success p-3 m-left mb-3">Log in use google account</button><br />
                <button onClick={handleFacebookSignIn} className="btn-success p-3 m-left">Log with use Facebook account</button>
            </div>
        </div>
    );
};
